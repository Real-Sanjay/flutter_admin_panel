      ...
      child: Column(
        ...
        children: [
          ...
          formRow('Order Sub Total:',
              Text('\u{20B9}${order?.orderTotal?.subtotal?.toStringAsFixed(2) ?? 'N/A'}', style: TextStyle(fontSize: 16))),
          formRow(
              'Discount:',
              Text('\u{20B9}${order?.orderTotal?.discount?.toStringAsFixed(2) ?? 'N/A'}',
                  style: TextStyle(fontSize: 16, color: Colors.red))),
          formRow(
              'Grand Total:',
              Text('\u{20B9}${order?.orderTotal?.total?.toStringAsFixed(2) ?? 'N/A'}',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          formRow(
            'Total Price:',
            Text('\u{20B9}${order?.totalPrice?.toStringAsFixed(2) ?? 'N/A'}',
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Padding(
          ...
          child: Text('${item.productName}: ${item.quantity} x \u{20B9}${item.price?.toStringAsFixed(2)}',
